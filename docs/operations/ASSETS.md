...
This document inventories all assets in `assets/img/tillerstead-work`, details their usage, and codifies naming, metadata, and compliance standards for future uploads. All practices reflect TCNA 2024 guidelines, New Jersey HIC requirements, and Tillerstead’s commitment to technical transparency and accessibility.
...
- **Metadata:** Every asset is registered in `_data/portfolio.yml` with accessible alt text, captions, and tags. All descriptions meet WCAG 2.1 AA and New Jersey Consumer Fraud Act standards.
...
2. **Registered all assets** in `_data/portfolio.yml` with descriptive, accessible alt text and captions per WCAG 2.1 AA and New Jersey HIC.
...
- Alt text and captions are reviewed for accessibility and New Jersey Consumer Fraud Act compliance.
