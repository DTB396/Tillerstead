...
Before promoting any changes to production, rigorously complete this checklist to uphold Tillerstead’s technical standards, regulatory compliance, and client trust. Reference TCNA 2024 guidelines, New Jersey HIC requirements, and internal `.ai/` policies throughout.
...
- [ ] **Jekyll Build Verification:** Ensure `bundle exec jekyll build` passes with no HTML or link errors (see [TCNA Section 4.1.2](https://www.tcnatile.com/), New Jersey HIC §13:45A-16.2).
...
- [ ] **Alt Text & Descriptions:** Informative images have precise alt text; decorative images use `role="presentation"` or empty alt attributes. Review for New Jersey Consumer Fraud Act compliance.
